                    ...
                    >
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-container text-text-muted">Or continue with</span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full py-3 px-6 border border-border rounded-md font-medium transition-all hover:bg-container flex items-center justify-center gap-3 mb-3"
                        >
                        ...
                        <button
                            ...
                            className="w-full py-3 px-6 border border-border rounded-md font-medium transition-all hover:bg-container flex items-center justify-center gap-3"
                        >
